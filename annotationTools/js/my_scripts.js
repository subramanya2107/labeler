...
//    LoadNewMedia();
//  }
  var nextImg= parseInt(main_media.GetFileInfo().GetImName().replace('.jpg','').replace("img_",""))+1;
  
  
  main_media.GetFileInfo().SetImName("img_"+nextImg+".jpg")
  main_media.GetFileInfo().SetURL(document.URL.split('?')[0])
