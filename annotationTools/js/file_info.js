...
function file_info() {
    ...
    */
    ...
    this.GetImagePath = function () {
        if((this.mode=='i') || (this.mode=='c') || (this.mode=='f') || (this.mode=='im') || (this.mode=='mt')) return FetchImageFromServerBaseURL + this.dir_name + '/' + this.im_name;
    };
    ...
    this.FetchImage = function () {
        var url = 'http://localhost:3000/fetch_image?mode=' + this.mode + '&username=' + username + '&collection=' + this.collection.toLowerCase() + '&folder=' + this.dir_name + '&image=' + this.im_name;
        var im_req;
